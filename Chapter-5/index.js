...
console.log(
  "// Finding the average year of origin for living and dead scripts"
);
function averageYear(array) {
  return array.reduce((a, b) => a + b) / array.length;
}
console.log(
  "Average year of origin for living scripts (filter(), map() and reduce())"
);
console.log(
  Math.round(averageYear(SCRIPTS.filter((s) => s.living).map((s) => s.year)))
);
...
console.log(
  "Average year of origin for dead scripts (filter(), map() and reduce())"
);
console.log(
  Math.round(averageYear(SCRIPTS.filter((s) => !s.living).map((s) => s.year)))
);
